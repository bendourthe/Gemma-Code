...
| v1.19.0 | Low-VRAM Agentic catalog: LFM2.5-2.6B CPU / sub-4 GB tool-calling pick, LFM Open License v1.0 use-restriction label, harness profile, 8B-A1B bake-off | In flight (Phases 1-3 landed; 8B-A1B declined) | [docs/v1/v1.19/](docs/v1/v1.19/) |
