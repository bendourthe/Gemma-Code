...
Bootstrap a personal "second brain" in the Nexus memory file architecture under `~/.nexus/memory/<workspace-id>/`. Schema in [docs/archive/versions/v0/v0.7.0/architecture.md](../../../docs/archive/versions/v0/v0.7.0/architecture.md) "Memory file architecture". See [build-second-brain/examples.md](./examples.md) for question scripts and extraction examples.
