# Contributing to Gemma Code -- the beginner's path

Welcome. If you have never contributed to an open-source project before, or you do not yet have Node.js installed, you are in the right place. This guide takes you end-to-end on a fresh machine: install the tools, fork the repo, build the extension, find an issue, ship a pull request. Tone is procedural; every command is something you can copy verbatim.
