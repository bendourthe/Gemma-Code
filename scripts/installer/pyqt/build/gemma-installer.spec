...
"""PyInstaller spec file for Gemma Code Installer.
...
if sys.platform == "win32":
    APP_NAME = "GemmaCodeSetup"
    ICON = str(REPO_ROOT / "assets" / "icon.ico")
elif sys.platform == "darwin":
    APP_NAME = "Gemma Code Installer"
...
a = Analysis(
    [str(PYQT_ROOT / "src" / "gemma_installer" / "main.py")],
