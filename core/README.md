...
Provides infrastructure consumed by every pillar module under [`../modules/`](../modules/). Per the v1.0.0 cycle plan ([../docs/v1.0.0/plans/phase-02-rebrand-and-core-extraction.md](../docs/v1.0.0/plans/phase-02-rebrand-and-core-extraction.md) sub-tasks 2.3 and 2.6), this tree owns:
...
During v1.0.0, the historical [`../src/`](../src/) tree still hosts the Coding engine. Once Phase 2.3's wholesale move completes (tracked in [`../docs/v1.0.0/known-gaps.md`](../docs/v1.0.0/known-gaps.md) under code `MV`), the layout simplifies to `core/` + `modules/<pillar>/`.
