...
| --- | --- | --- |
| `coverage-gate` fails with "below 80%" | new module not covered by tests | add targeted unit tests; see [docs/v0.3.0/performance-benchmarks.md](performance-benchmarks.md) for patterns |
