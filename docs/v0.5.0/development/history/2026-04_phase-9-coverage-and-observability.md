...
**Date**: 2026-04-26
**Plan**: [docs/v0.5.0/plans/implementation-plan.md](../../plans/implementation-plan.md) (Phase 9) referencing [docs/v0.5.0/plans/token-optimizer-adoption.md](../../plans/token-optimizer-adoption.md) sub-tasks 4.1-4.4 and [docs/v0.5.0/plans/memory-hygiene.md](../../plans/memory-hygiene.md) sub-task 3.2
**Status**: Complete
...
**Files**:
- [src/tools/handlers/webCache.ts](../../../../src/tools/handlers/webCache.ts) (new)
- [src/tools/handlers/webSearch.ts](../../../../src/tools/handlers/webSearch.ts) (cache lookup + store wiring)
- [src/panels/GemmaCodePanel.ts](../../../../src/panels/GemmaCodePanel.ts) (instantiation + dispose)
- [tests/unit/tools/handlers/webCache.test.ts](../../../../tests/unit/tools/handlers/webCache.test.ts)
- [tests/integration/web-search-cache.test.ts](../../../../tests/integration/web-search-cache.test.ts)
...
**Files**:
- [src/observability/TraceStore.ts](../../../../src/observability/TraceStore.ts) (5 s `setInterval` flush, 100-event batch, `dispose()`, `flushImmediately()`, `bufferStats()`)
- [src/observability/MetricsCollector.ts](../../../../src/observability/MetricsCollector.ts) (pass-through `bufferStats` + `flushImmediately`)
- [tests/unit/observability/MetricsCollector.buffered.test.ts](../../../../tests/unit/observability/MetricsCollector.buffered.test.ts)
...
**Files**:
- [src/panels/TraceDashboardPanel.ts](../../../../src/panels/TraceDashboardPanel.ts) (new `CacheStatsProviders` constructor arg, `buildCacheStatsPayload()`, 5 s refresh timer)
- [src/panels/messages.ts](../../../../src/panels/messages.ts) (new `cacheStats` and `requestCacheStats` message types)
- [src/panels/webview/traceDashboard.ts](../../../../src/panels/webview/traceDashboard.ts) (three new panels rendered through the existing escape-then-set pipeline)
- [src/extension.ts](../../../../src/extension.ts) (wires `chatPanel.getToolOutputCache()` and `chatPanel.getWebResponseCache()` into the dashboard panel)
- [src/panels/GemmaCodePanel.ts](../../../../src/panels/GemmaCodePanel.ts) (new `getToolOutputCache()` and `getWebResponseCache()` accessors)
- [tests/unit/panels/TraceDashboardPanel.cache.test.ts](../../../../tests/unit/panels/TraceDashboardPanel.cache.test.ts)
...
**Files**:
- [src/observability/OperationLog.ts](../../../../src/observability/OperationLog.ts) (new)
- [src/tools/AgentLoop.ts](../../../../src/tools/AgentLoop.ts) (records each tool call after execution)
- [src/panels/GemmaCodePanel.ts](../../../../src/panels/GemmaCodePanel.ts) (init + slash-command handler + dispose + settings-change wiring)
- [src/commands/CommandRouter.ts](../../../../src/commands/CommandRouter.ts) (`/operation-log` builtin)
- [src/config/settings.ts](../../../../src/config/settings.ts), [package.json](../../../../package.json) (new `gemma-code.operationLog.enabled` setting, default `false`)
- [tests/unit/observability/OperationLog.test.ts](../../../../tests/unit/observability/OperationLog.test.ts)
- [tests/integration/operation-log-end-to-end.test.ts](../../../../tests/integration/operation-log-end-to-end.test.ts)
...
- [tests/unit/tools/handlers/webCache.test.ts](../../../../tests/unit/tools/handlers/webCache.test.ts) -- 9 tests
- [tests/integration/web-search-cache.test.ts](../../../../tests/integration/web-search-cache.test.ts) -- 2 tests
- [tests/unit/observability/MetricsCollector.buffered.test.ts](../../../../tests/unit/observability/MetricsCollector.buffered.test.ts) -- 6 tests
- [tests/unit/panels/TraceDashboardPanel.cache.test.ts](../../../../tests/unit/panels/TraceDashboardPanel.cache.test.ts) -- 2 tests
- [tests/unit/observability/OperationLog.test.ts](../../../../tests/unit/observability/OperationLog.test.ts) -- 9 tests
- [tests/integration/operation-log-end-to-end.test.ts](../../../../tests/integration/operation-log-end-to-end.test.ts) -- 2 tests
...
- [x] In-process LRU layer measurable via `lruStats()` (Phase 4 carry-over; verified by [tests/unit/storage/ToolOutputCache.test.ts](../../../../tests/unit/storage/ToolOutputCache.test.ts))
