...
**Date**: 2026-04-25
**Plan**: [docs/v0.5.0/plans/implementation-plan.md](../../plans/implementation-plan.md) (Phase 6) referencing [docs/v0.5.0/plans/agent-friendly-tools.md](../../plans/agent-friendly-tools.md) sub-tasks 3.1 and 3.2
**Status**: Complete
...
**Files**:
- [src/tools/handlers/terminal.ts](../../../../src/tools/handlers/terminal.ts) (`RunTerminalTool` accepts `dry_run`; new `findBlockedPattern` helper; private `_dryRunReport` builder)
- [src/tools/handlers/filesystem.ts](../../../../src/tools/handlers/filesystem.ts) (`DeleteFileTool` accepts `dry_run`; private `_dryRunReport` builder; `crypto.createHash('sha256')` SHA over the first 1 MB of content)
- [src/tools/types.ts](../../../../src/tools/types.ts) (`RunTerminalParams.dry_run?` and `DeleteFileParams.dry_run?` declared)
- [src/tools/ToolCatalog.ts](../../../../src/tools/ToolCatalog.ts) (schema entries updated with the new parameter and the per-spec usage hint)
...
**Files**:
- [src/tools/handlers/filesystem.ts](../../../../src/tools/handlers/filesystem.ts) (new `renderListDirectoryJson` and `renderGrepJson` helpers; shared `truncationMessage` helper; `FORMAT_JSON_BYTE_CAP = 64 KB` constant)
- [src/tools/types.ts](../../../../src/tools/types.ts) (`ListDirectoryParams.format?` and `GrepCodebaseParams.format?` declared)
- [src/tools/ToolCatalog.ts](../../../../src/tools/ToolCatalog.ts) (schema entries updated)
...
**Files**:
- [tests/unit/tools/handlers/dry_run.adversarial.test.ts](../../../../tests/unit/tools/handlers/dry_run.adversarial.test.ts) (200-iteration LCG fuzz against both handlers)
- [tests/integration/dry-run-end-to-end.test.ts](../../../../tests/integration/dry-run-end-to-end.test.ts)
- [tests/integration/format-json-end-to-end.test.ts](../../../../tests/integration/format-json-end-to-end.test.ts)
...
A  docs/v0.5.0/development/history/2026-04_phase-6-mutation-safety-and-structured-outputs.md
...
1. Mark the Phase 6 exit checklist boxes in [docs/v0.5.0/plans/implementation-plan.md](../../plans/implementation-plan.md).
