...
`commit`, `review-pr`, `generate-readme`, `generate-changelog`, `generate-tests`, `analyze-codebase`, `setup-project`. See [docs/archive/versions/v0/v0.6.0/architecture.md](../v0.6.0/architecture.md) for the v0.6.0 baseline.
