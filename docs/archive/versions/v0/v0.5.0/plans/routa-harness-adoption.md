...
**Created**: 2026-04-24
**Source Comparison**: [docs/archive/versions/v0/v0.5.0/comparison/comparison-routa.md](../comparison/comparison-routa.md)
...
**Prompt**:
> Generate and run comprehensive tests for Phase 1 of the routa-harness adoption (`docs/archive/versions/v0/v0.5.0/plans/routa-harness-adoption.md`). Specifically:
>
...
> - Document the override mechanism in `CONTRIBUTING.md` and `docs/archive/versions/v0/v0.5.0/architecture.md`.
>
...
- [ ] `CONTRIBUTING.md` and `docs/archive/versions/v0/v0.5.0/architecture.md` document the override
- [ ] Session history generated
...
>   - `"deps:graph": "depcruise --config configs/dependency-cruiser.cjs --output-type dot src | dot -Tsvg > docs/archive/versions/v0/v0.5.0/dep-graph.svg"`
>
...
> 5. Run `npm run deps:graph` (if graphviz is installed) and visually inspect `docs/archive/versions/v0/v0.5.0/dep-graph.svg`.
...
>
> Use the severity rubric from the 7-principles article (`Blocker / Friction / Optimization`) — referenced in the parallel `docs/archive/versions/v0/v0.5.0/comparison/comparison-7-principles-for-agent-friendly-clis.md` adoption.
>
> Constraints:
...
> 4. Verify `docs/refactor-playbook.md` is cross-referenced from `CONTRIBUTING.md` and `docs/archive/versions/v0/v0.5.0/test-pyramid.md`.
...
- [ ] `CONTRIBUTING.md` and `docs/archive/versions/v0/v0.5.0/test-pyramid.md` cross-reference the new docs
...
> 10. Update `docs/archive/versions/v0/v0.5.0/architecture.md` "Cache architecture" section (if added by the parallel token-optimizer plan) to also reference the harness layer.
