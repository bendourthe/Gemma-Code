...
- [x] `docs/refactor-playbook.md`, `docs/issues/_template.md`, `docs/archive/versions/v0/v0.5.0/tool-audit.md` published -- [refactor-playbook.md](../../refactor-playbook.md), [issues/_template.md](../../issues/_template.md), [tool-audit.md](../tool-audit.md)
