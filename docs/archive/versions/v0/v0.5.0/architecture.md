...
See [docs/adr/](../../../adr/) for the canonical text. The post-cycle architecture document for v0.6.0 lives at [docs/archive/versions/v0/v0.6.0/architecture.md](../v0.6.0/architecture.md).
