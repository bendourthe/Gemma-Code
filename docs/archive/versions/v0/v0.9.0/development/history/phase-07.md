...
Read the full Phase 7 section of the cycle plan, the v0.8.0 post-CI audit follow-up rows 10.O.AB through 10.O.AG in [docs/archive/versions/v0/v0.8.0/known-gaps.md](../../../v0.8.0/known-gaps.md), and the current state of [.github/workflows/ci.yml](../../../../.github/workflows/ci.yml). Phase 6 close was 19 open / 22 resolved; the six Phase 7 follow-ups were the entire scope of this phase (one phase per sub-task, no carryover code work).
