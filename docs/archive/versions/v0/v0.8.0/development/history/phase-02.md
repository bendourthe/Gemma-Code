...
- Added an "Attack Path D" section to [docs/archive/versions/v0/v0.6.0/review/penetration-test.md](../../../v0.6.0/review/penetration-test.md) documenting the indirect-prompt-injection threat model + the v0.8.0 defenses + the residual risk.
...
- Amended [docs/archive/versions/v0/v0.7.0/architecture.md](../../../v0.7.0/architecture.md) Section 1 with the v0.8.0 extension table.
