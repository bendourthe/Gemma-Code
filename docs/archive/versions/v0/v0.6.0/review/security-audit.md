...
**Location**: [src/storage/ToolOutputCache.ts](../../../../../src/storage/ToolOutputCache.ts), [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5.0/architecture.md) Section 4
...
2. (b) update [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5.0/architecture.md) to say "provenance is recorded for `/cache reembed` to consume; threshold elevation is deferred to v0.6.0" and remove the false claim.
...
**Location**: [docs/archive/versions/v0/v0.5.0/plans/routa-harness-adoption.md](../../v0.5.0/plans/routa-harness-adoption.md)
