...
- **Location**: [src/storage/ToolOutputCache.ts](../../../../../src/storage/ToolOutputCache.ts) `prune()` method; [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5.0/architecture.md) Section 4
