...
**Inputs folded in**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](./known-gaps.md), [docs/archive/versions/v0/v0.6.0/review/security-audit.md](./security-audit.md).
...
3. Document the spawn-trust contract in [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5.0/architecture.md) so users know what they are agreeing to when they enable MCP.
