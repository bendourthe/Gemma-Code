...
Updated [docs/adr/README.md](../../../adr/README.md) index with five new rows. Updated [docs/archive/versions/v0/v0.5.0/architecture.md](../../../v0.5.0/architecture.md) Section 11 ADR roll-up table to include the five v0.6.0 ADRs and a pointer at the v0.6.0 architecture doc.
...
- [docs/archive/versions/v0/v0.5.0/architecture.md](../../../v0.5.0/architecture.md) -- Section 11 ADR roll-up table extended with five new rows; cross-link added to v0.6.0 architecture doc.
