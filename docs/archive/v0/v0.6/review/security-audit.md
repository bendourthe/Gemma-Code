...
**Inputs folded in**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) (carried forward as post-release self-audit context)
...
**Location**: [src/storage/ToolOutputCache.ts](../../../../src/storage/ToolOutputCache.ts), [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5/architecture.md) Section 4
**Carried from**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) section 4.2
...
2. (b) update [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5/architecture.md) to say "provenance is recorded for `/cache reembed` to consume; threshold elevation is deferred to v0.6.0" and remove the false claim.
...
**Carried from**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) section 4.3
...
**Carried from**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) sections 1.1 + 1.2
...
**Location**: [docs/archive/versions/v0/v0.5.0/plans/routa-harness-adoption.md](../../v0.5/plans/routa-harness-adoption.md)
**Carried from**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) section 6.3
...
**Carried from**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) section 6.4
...
**Carried from**: [docs/archive/versions/v0/v0.5.0/known-gaps.md](known-gaps.md) section 9.7
...
- `[.gitignore](../../../versions/.gitignore)` covers `.env*`, `*.pem`, `*.key`, `*.p12`, `*.pfx`, `*_rsa`, `*_ed25519`, `credentials.json`, `secrets.json`, `.npmrc`, `*.sqlite`. **PASS**.
