...
3. Document the spawn-trust contract in [docs/archive/versions/v0/v0.5.0/architecture.md](../../v0.5/architecture.md) so users know what they are agreeing to when they enable MCP.
