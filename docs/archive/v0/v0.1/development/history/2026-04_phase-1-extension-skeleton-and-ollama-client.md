...
- **Plan reference**: `docs/archive/versions/v0/v0.1.0/implementation-plan.md`
...
3. Begin Phase 2 — implement `ConversationManager` (`src/chat/ConversationManager.ts`) and the `GemmaCodePanel` WebviewViewProvider, following sub-tasks 2.1 and 2.2 in `docs/archive/versions/v0/v0.1.0/implementation-plan.md`.
