...
**Sibling reviews**: [docs/archive/versions/v0/v0.6.0/review/known-gaps.md](../v0.6/review/known-gaps.md) (the v0.5.0 carryover catalog that drove v0.6.0); [docs/archive/versions/v0/v0.6.0/review/codebase-review.md](../v0.6/review/codebase-review.md); [docs/archive/versions/v0/v0.6.0/review/penetration-test.md](../v0.6/review/penetration-test.md).
...
|---|---|---|---|---|---|
| 10.O.1 | Phase 4 | docs/archive/versions/v0/v0.7.0/plans/v0.7.0-cycle.md Phase 4 stability gate | NI | resolved in v0.8.0 Phase 0.3 (2026-05-15) | Closed in [docs/archive/versions/v0/v0.8.0/known-gaps.md](../v0.8/known-gaps.md) Section 10.2. `ChatWebviewHost.postMessage` now emits `renderQueuedMessageField` toggles on every `status` transition; regression tests in `tests/unit/panels/ChatWebviewHost.test.ts`. |
...
| 10.O.19 | v0.7.1 hotfix | docs/archive/versions/v0/v0.7.0/known-gaps.md item 2.1 resolution | BG | resolved in v0.8.0 Phase 0.9 (2026-05-15) | Closed. `MarkdownRenderer` now caches a single `new Marked()` instance instead of using `marked.parse()` shorthand. `--exclude '^render ~.*-token message$'` rule removed from `.github/workflows/nightly.yml`. Post-fix bench numbers tracked in [docs/archive/versions/v0/v0.8.0/performance-baselines.md](../v0.8/performance-baselines.md) (operator-capture pending). |
