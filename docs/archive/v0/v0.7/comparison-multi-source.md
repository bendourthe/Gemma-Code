...
| Scale | ~24k LOC TS; 16 modules per [docs/index.md](../../versions/docs/index.md) | ~few k LOC TS | Skill MD + small TS CLI | ~5k LOC TS | very large, multi-language |
...
| C2 | Four-layer memory (Working + Episodic + Semantic + Graph) | G | [ADR-0002](../../versions/docs/adr/0002-memory-subsystem-layering.md) |
...
| ADR record | 5 ADRs at [docs/adr/](../../versions/docs/adr) | none | ADR-001..ADR-N at [`ruflo/docs/adr/`](https://github.com/ruvnet/ruflo/tree/main/docs/adr) | Gemma's ADR discipline is healthy. |
...
| E2E tests | no formal Playwright setup; relies on golden-task harness | none | yes (browser plugin) | Gap noted in [known-gaps.md](../v0.6/review/known-gaps.md) section 2. |
