...
**Date**: 2026-05-16
**Plan**: `docs/archive/versions/v0/v0.8.0/plans/v0.8.0-cycle.md` Phase 5
**Outcome**: 12 of 12 sub-tasks shipped. 88 new unit tests pass on top of the existing suite; `npm run lint` and `npm run build` are green. Four new gap entries (10.O.O / .P / .Q / .R) and two carryover resolutions (v0.7.0 10.O.5 / 10.O.6) captured in `docs/archive/versions/v0/v0.8.0/known-gaps.md`.
...
10. **5.10 -- Memory.md promotion mapping** (`src/panels/MemoryPanel.ts` + `docs/archive/versions/v0/v0.8.0/memory-promotion-mapping.md`). `sectionForType` now accepts an override map; `gemma-code.memory.promotionMapping` setting exposes the override.
11. **5.11 -- Phase 3 context-limits cross-link** (`docs/archive/versions/v0/v0.7.0/architecture.md` Phase 5 section). One-paragraph blockquote pointing at v0.7.0 Phase 3 sub-task 3.7.
...
### New documentation
- `docs/archive/versions/v0/v0.8.0/memory-promotion-mapping.md`
- `docs/archive/versions/v0/v0.8.0/development/history/phase-05.md` (this file)

### Modified documentation
- `docs/archive/versions/v0/v0.7.0/architecture.md` (cross-link)
- `docs/archive/versions/v0/v0.7.0/known-gaps.md` (10.O.5 / 10.O.6 moved to Resolved)
- `docs/archive/versions/v0/v0.8.0/known-gaps.md` (added 10.O.O / .P / .Q / .R; resolved 10.O.5 / 10.O.6)
