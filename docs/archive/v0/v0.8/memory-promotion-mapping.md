...
**Cross-references**:
- `docs/archive/versions/v0/v0.7.0/known-gaps.md` Section 10 row 10.O.5 (the open item this document closes).
- `docs/archive/versions/v0/v0.8.0/plans/v0.8.0-cycle.md` Phase 5 sub-task 5.10.
...
3. Telemetry / chat feedback is collected in `docs/archive/versions/v0/v0.8.0/known-gaps.md` Section 10 if anyone hits a mapping they want to change.
...
This document plus the `gemma-code.memory.promotionMapping` setting closes the v0.7.0 open item 10.O.5 ("Promote-to-Memory section mapping"). The item is moved from `## Open Items` to `## Resolved` in `docs/archive/versions/v0/v0.7.0/known-gaps.md` with the note "Resolved in v0.8.0 Phase 5.10".
