...
- **Prior session reference**: [2026-04-16_phase-8-golden-task-suite.md](../../../v0.3/development/history/2026-04-16_phase-8-golden-task-suite.md) (last v0.3.0 session)
...
**Key files changed**: [src/orchestration/TaskDAG.ts:199-215](../../../../versions/src/orchestration/TaskDAG.ts#L199-L215), [tests/unit/orchestration/TaskDAG.test.ts](../../../../versions/tests/unit/orchestration/TaskDAG.test.ts)
...
**Key files changed**: [src/storage/GraphMemory.ts:345](../../../../versions/src/storage/GraphMemory.ts#L345), [src/storage/GraphQueryEngine.ts:301-315](../../../../versions/src/storage/GraphQueryEngine.ts#L301-L315), [tests/unit/storage/GraphQueryEngine.test.ts](../../../../versions/tests/unit/storage/GraphQueryEngine.test.ts)
...
**Key files changed**: [src/storage/ChatHistoryStore.ts:57-100](../../../../versions/src/storage/ChatHistoryStore.ts#L57-L100), [tests/unit/storage/ChatHistoryStore.test.ts](../../../../versions/tests/unit/storage/ChatHistoryStore.test.ts)
...
**What happened**: Created [src/tools/handlers/pathGuard.ts](../../../../versions/src/tools/handlers/pathGuard.ts) with a `resolveInsideWorkspace` helper that handles absolute-path, workspace-relative, and symlink cases (via `fs.realpathSync`). `run_terminal` now routes every `cwd` through it; rejections return a `failResult` with a clear message naming the workspace root. Added two test cases: absolute-path-outside rejected, relative-subdir accepted.
...
**Key files changed**: [src/tools/handlers/pathGuard.ts](../../../../versions/src/tools/handlers/pathGuard.ts) (new), [src/tools/handlers/terminal.ts:80-92](../../../../versions/src/tools/handlers/terminal.ts#L80-L92), [tests/unit/tools/handlers/terminal.test.ts](../../../../versions/tests/unit/tools/handlers/terminal.test.ts)
...
**Key files changed**: [package.json](../../../../versions/package.json), [src/config/settings.ts:51](../../../../versions/src/config/settings.ts#L51), [CHANGELOG.md](../../../../versions/CHANGELOG.md)
...
**Key files changed**: [tests/unit/mcp/McpToolHandler.test.ts](../../../../versions/tests/unit/mcp/McpToolHandler.test.ts) (new)
...
**Key files changed**: [src/utils/MarkdownRenderer.ts](../../../../versions/src/utils/MarkdownRenderer.ts), [src/panels/webview/index.ts:37](../../../../versions/src/panels/webview/index.ts#L37), [src/panels/webview/traceDashboard.ts:14](../../../../versions/src/panels/webview/traceDashboard.ts#L14), [package.json](../../../../versions/package.json) (added isomorphic-dompurify), [tests/unit/utils/MarkdownRenderer.test.ts](../../../../versions/tests/unit/utils/MarkdownRenderer.test.ts) (new)
...
**Key files changed**: [src/panels/SessionListPanel.ts:215-236](../../../../versions/src/panels/SessionListPanel.ts#L215-L236), [tests/unit/panels/SessionListPanel.test.ts](../../../../versions/tests/unit/panels/SessionListPanel.test.ts) (new)
...
- Installer: [scripts/installer/pyqt/src/gemma_installer/engine/venv_installer.py](../../../../versions/scripts/installer/pyqt/src/gemma_installer/engine/venv_installer.py) became a no-op stub that logs "Python backend is no longer bundled" and returns success.
- Tests: dropped `useBackend: ...` entries from `extension.test.ts`, `GpuTierConfig.test.ts`, `GemmaCodePanel.test.ts`.

Wrote [docs/adr/0001-python-backend-disposition.md](../../../../versions/v0/adr/0001-python-backend-disposition.md) in MADR format: Context, Decision, Consequences (positive / negative / neutral), Alternatives, Compliance follow-up. The ADR explicitly notes that Phase 2 sub-tasks 2.2, 2.11, 2.13 are now N/A because they targeted the backend surface.
...
**Key files changed / deleted**: 30+ files under `src/backend/` deleted; [src/extension.ts](../../../../versions/src/extension.ts), [src/config/settings.ts](../../../../versions/src/config/settings.ts), [package.json](../../../../versions/package.json), [.github/workflows/ci.yml](../../../../versions/.github/workflows/ci.yml), [.github/workflows/nightly.yml](../../../../versions/.github/workflows/nightly.yml), [configs/vitest.config.ts](../../../../versions/configs/vitest.config.ts), [scripts/installer/pyqt/src/gemma_installer/engine/venv_installer.py](../../../../versions/scripts/installer/pyqt/src/gemma_installer/engine/venv_installer.py); [docs/adr/0001-python-backend-disposition.md](../../../../versions/v0/adr/0001-python-backend-disposition.md) (new)
...
**Verification**:
- [tests/unit/storage/MemorySubsystem.test.ts](../../../../versions/tests/unit/storage/MemorySubsystem.test.ts): 4 cases (disabled contract, wired layers, graph-engine binding, isReady semantics).
- `wc -l src/panels/GemmaCodePanel.ts`: 1307 -> 1223 (84-line reduction; plan required >= 80).
- All existing panel tests pass unchanged.

**Key files changed**: [src/storage/MemorySubsystem.ts](../../../../versions/src/storage/MemorySubsystem.ts) (new), [src/panels/GemmaCodePanel.ts](../../../../versions/src/panels/GemmaCodePanel.ts), [tests/unit/storage/MemorySubsystem.test.ts](../../../../versions/tests/unit/storage/MemorySubsystem.test.ts) (new)
...
**Key files changed**: [tests/integration/safety/agent-safety-pipeline.test.ts](../../../../versions/tests/integration/safety/agent-safety-pipeline.test.ts) (new)
...
**Key files changed**: [src/observability/TraceStore.ts](../../../../versions/src/observability/TraceStore.ts), [tests/unit/observability/TraceStore.test.ts](../../../../versions/tests/unit/observability/TraceStore.test.ts)
...
**Key files changed**: [src/storage/MemoryStore.ts](../../../../versions/src/storage/MemoryStore.ts)
...
**What happened**: Created [scripts/check-bench-regressions.mjs](../../../../versions/scripts/check-bench-regressions.mjs) with args `--baseline`, `--current`, `--regression-pct`, `--update-baseline`. It walks a vitest bench JSON report (`files[].result.tasks[]`), extracts `hz`/`mean`/`rme` per task name, diffs against the baseline's saved hz per name, exits 1 on any regression worse than the threshold. `--update-baseline` writes the current run into the baseline file for future comparisons. Created [tests/benchmarks/baselines/v0.3.0.json](../../../../versions/tests/benchmarks/baselines/v0.3.0.json) as a template with empty `benchmarks: {}` (to be populated on the first post-merge nightly). Updated `.github/workflows/nightly.yml` bench step to pipe JSON output and invoke the checker.
...
**Key files changed**: [scripts/check-bench-regressions.mjs](../../../../versions/scripts/check-bench-regressions.mjs) (new), [tests/benchmarks/baselines/v0.3.0.json](../../../../versions/tests/benchmarks/baselines/v0.3.0.json) (new), [.github/workflows/nightly.yml](../../../../versions/.github/workflows/nightly.yml)
...
**What happened**: Created [tests/golden/framework/run_all.py](../../../../versions/tests/golden/framework/run_all.py) -- loads every task via `task_loader.load_all_tasks`, runs each in `live` mode via `task_runner.run_task`, writes raw results JSON, compares against baseline via `framework.regression.detect_regressions`, renders Markdown via `framework.reporter.render_markdown_report`, exits 1 on any error-severity regression. Rewrote `.github/workflows/golden-tasks.yml` to matrix e2b + e4b with `fail-fast: false`, pull the matching Ollama model per tier, run `run_all.py`, and upload both the JSON results and the Markdown report as artifacts.

**Key files changed**: [tests/golden/framework/run_all.py](../../../../versions/tests/golden/framework/run_all.py) (new), [.github/workflows/golden-tasks.yml](../../../../versions/.github/workflows/golden-tasks.yml)
