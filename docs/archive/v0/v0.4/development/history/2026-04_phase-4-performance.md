...
**Date:** 2026-04-19
**Plan:** [docs/archive/versions/v0/v0.4.0/implementation-plan.md](../../implementation-plan.md) Phase 4
**Findings closed:** 20 (9 P1 + 8 P2 + 3 P3) from [docs/archive/versions/v0/v0.3.0/review.md](../../../v0.3/review.md)
...
- **File:** [src/extension.ts](../../../../versions/src/extension.ts)
...
- **File:** [src/chat/CompactionStrategy.ts](../../../../versions/src/chat/CompactionStrategy.ts)
...
- **Files:** [src/chat/ConversationManager.ts](../../../../versions/src/chat/ConversationManager.ts), [src/chat/CompactionStrategy.ts](../../../../versions/src/chat/CompactionStrategy.ts)
...
- **File:** [src/panels/GemmaCodePanel.ts](../../../../versions/src/panels/GemmaCodePanel.ts)
...
- **File:** [src/panels/GemmaCodePanel.ts](../../../../versions/src/panels/GemmaCodePanel.ts)
- **Implementation:** The `messages` payload now preserves metadata (id, role, timestamp) and keeps user content (still needed for plain-text rendering in the webview), but replaces assistant `content` with empty string. The authoritative source for assistant rendering is `renderedHtmlMap` -- the webview already preferred it before falling back to `escapeTextToHtml(content)`, so a 50-message session's payload drops by roughly half. Webview consumer in [src/panels/webview/index.ts](../../../../versions/src/panels/webview/index.ts) was unchanged -- the existing `renderedHtmlMap[msg.id] ?? escapeTextToHtml(msg.content)` fallback remains safe because every assistant message now carries a map entry.

### 4.19 Flip retainContextWhenHidden and add rehydrate path
- **Files:** [src/extension.ts](../../../../versions/src/extension.ts), [src/panels/GemmaCodePanel.ts](../../../../versions/src/panels/GemmaCodePanel.ts)
...
- **Files:** [src/tools/Gemma4ToolFormat.ts](../../../../versions/src/tools/Gemma4ToolFormat.ts), [src/tools/ToolCallParser.ts](../../../../versions/src/tools/ToolCallParser.ts), [src/tools/AgentLoop.ts](../../../../versions/src/tools/AgentLoop.ts)
...
- **File:** [src/storage/ChatHistoryStore.ts](../../../../versions/src/storage/ChatHistoryStore.ts)
...
- **Files:** [src/storage/GraphMemory.ts](../../../../versions/src/storage/GraphMemory.ts), [src/storage/GraphQueryEngine.ts](../../../../versions/src/storage/GraphQueryEngine.ts)
...
- **Files:** [src/storage/MemoryStore.ts](../../../../versions/src/storage/MemoryStore.ts), [src/storage/EpisodicMemory.ts](../../../../versions/src/storage/EpisodicMemory.ts), [src/storage/MemorySubsystem.ts](../../../../versions/src/storage/MemorySubsystem.ts), [src/panels/GemmaCodePanel.ts](../../../../versions/src/panels/GemmaCodePanel.ts)
...
- **Files:** [src/storage/MemoryStore.ts](../../../../versions/src/storage/MemoryStore.ts), [src/storage/EmbeddingClient.ts](../../../../versions/src/storage/EmbeddingClient.ts) (already has `embedBatch`)
...
- **File:** [src/storage/MemoryStore.ts](../../../../versions/src/storage/MemoryStore.ts)
...
- **Files:** [src/observability/TraceStore.ts](../../../../versions/src/observability/TraceStore.ts), [src/observability/MetricsCollector.ts](../../../../versions/src/observability/MetricsCollector.ts)
...
- **File:** [src/utils/MarkdownRenderer.ts](../../../../versions/src/utils/MarkdownRenderer.ts)
...
- **File:** [src/storage/ConversationSync.ts](../../../../versions/src/storage/ConversationSync.ts)
...
- **File:** [src/storage/MemorySubsystem.ts](../../../../versions/src/storage/MemorySubsystem.ts)
...
- **Benchmarks baseline:** [tests/benchmarks/baselines/v0.4.0.json](../../../../versions/tests/benchmarks/baselines/v0.4.0.json) seeded in the same shape as v0.3.0 (empty benchmarks object, `thresholds.regressionPct = 20`). The nightly CI workflow will populate it via `--update-baseline` on the first run after v0.4.0 merges, matching the pattern used for v0.3.0.
- **Bench gating script:** [scripts/check-bench-regressions.mjs](../../../../versions/scripts/check-bench-regressions.mjs) gained a `--floor` flag. Benchmarks missing from the primary baseline fall through to the floor; both are silent no-ops for benchmarks that have never been measured. [.github/workflows/nightly.yml](../../../../versions/.github/workflows/nightly.yml) now passes `--baseline v0.4.0.json --floor v0.3.0.json`.
...
- `docs/archive/versions/v0/v0.4.0/development/history/2026-04_phase-4-performance.md` (this file)
