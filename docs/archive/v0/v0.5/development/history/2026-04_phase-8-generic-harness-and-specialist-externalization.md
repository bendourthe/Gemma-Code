...
**Date**: 2026-04-26
**Plan**: [docs/archive/versions/v0/v0.5.0/plans/implementation-plan.md](../../plans/implementation-plan.md) (Phase 8) referencing [docs/archive/versions/v0/v0.5.0/plans/routa-harness-adoption.md](../../plans/routa-harness-adoption.md) sub-tasks 1.1-1.3 and 2.1-2.2
**Status**: Complete
...
**Files**:
- [scripts/hooks/check-tool-permission.mjs](../../../../versions/scripts/hooks/check-tool-permission.mjs)
- [scripts/hooks/lib/secret-paths.mjs](../../../../versions/scripts/hooks/lib/secret-paths.mjs) (canonical secret-path patterns)
- [src/tools/handlers/secretPaths.ts](../../../../versions/src/tools/handlers/secretPaths.ts) (header comment now points at the .mjs file as authoritative)
...
**Files**:
- [scripts/hooks/check-prompt-policy.mjs](../../../../versions/scripts/hooks/check-prompt-policy.mjs)
...
**Files**:
- [tests/unit/agents/SubAgentManager.characterization.test.ts](../../../../versions/tests/unit/agents/SubAgentManager.characterization.test.ts)
- [tests/snapshots/specialists/research.txt](../../../../versions/tests/snapshots/specialists/research.txt)
- [tests/snapshots/specialists/verification.txt](../../../../versions/tests/snapshots/specialists/verification.txt)
- [tests/snapshots/specialists/planning.txt](../../../../versions/tests/snapshots/specialists/planning.txt)
- [tests/snapshots/specialists/tool-scope.json](../../../../versions/tests/snapshots/specialists/tool-scope.json)
...
**Files**:
- [assets/specialists/research.md](../../../../versions/assets/specialists/research.md)
- [assets/specialists/verification.md](../../../../versions/assets/specialists/verification.md)
- [assets/specialists/planning.md](../../../../versions/assets/specialists/planning.md)
- [assets/specialists/orchestration.md](../../../../versions/assets/specialists/orchestration.md)
- [src/agents/SpecialistLoader.ts](../../../../versions/src/agents/SpecialistLoader.ts)
- [src/agents/SubAgentManager.ts](../../../../versions/src/agents/SubAgentManager.ts) (now accepts an optional `SpecialistLoader`)
- [.vscodeignore](../../../../versions/.vscodeignore) (`!assets/specialists/**` so the bundle ships)
...
**Files**:
- [tests/unit/hooks/check-tool-permission.test.ts](../../../../versions/tests/unit/hooks/check-tool-permission.test.ts)
- [tests/unit/hooks/check-git-control-plane.test.ts](../../../../versions/tests/unit/hooks/check-git-control-plane.test.ts)
- [tests/unit/hooks/check-prompt-policy.test.ts](../../../../versions/tests/unit/hooks/check-prompt-policy.test.ts)
- [tests/unit/hooks/secret-paths-sync.test.ts](../../../../versions/tests/unit/hooks/secret-paths-sync.test.ts)
- [tests/unit/agents/SpecialistLoader.test.ts](../../../../versions/tests/unit/agents/SpecialistLoader.test.ts)
- [tests/integration/hooks/preToolUse.test.ts](../../../../versions/tests/integration/hooks/preToolUse.test.ts)
- [tests/benchmarks/hooks.bench.ts](../../../../versions/tests/benchmarks/hooks.bench.ts)
...
- **`SubAgentManager` keeps a hardcoded `TOOLS_BY_TYPE` map**. The plan suggests deleting the static map once `SpecialistLoader` is wired. Phase 8 keeps it as a fallback when no `SpecialistLoader` is supplied to the constructor (defaults to `null`). This preserves byte-equivalence for any caller that has not been updated to pass the loader, including existing tests, and makes the refactor zero-risk. The map and the bundled file are kept in sync by [tests/unit/agents/SpecialistLoader.test.ts](../../../../versions/tests/unit/agents/SpecialistLoader.test.ts) (`bundled X prompt equals hardcoded fallback` cases).
...
A  docs/archive/versions/v0/v0.5.0/development/history/2026-04_phase-7-memory-hygiene-and-corroboration.md
A  docs/archive/versions/v0/v0.5.0/development/history/2026-04_phase-8-generic-harness-and-specialist-externalization.md
...
1. Mark the Phase 8 exit checklist boxes in [docs/archive/versions/v0/v0.5.0/plans/implementation-plan.md](../../plans/implementation-plan.md).
