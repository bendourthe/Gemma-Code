...
**Files**: [src/tools/OutputRedirector.ts](../../../../versions/src/tools/OutputRedirector.ts), [src/tools/ToolRegistry.ts](../../../../versions/src/tools/ToolRegistry.ts)
...
**Files**: [src/tools/handlers/filesystem.ts](../../../../versions/src/tools/handlers/filesystem.ts), [src/tools/types.ts](../../../../versions/src/tools/types.ts), [src/tools/ToolCatalog.ts](../../../../versions/src/tools/ToolCatalog.ts)
...
The `ReadFileParams` interface in [src/tools/types.ts](../../../../versions/src/tools/types.ts) was extended with the new fields, and the `read_file` schema in [src/tools/ToolCatalog.ts](../../../../versions/src/tools/ToolCatalog.ts) now documents `range_start`, `range_end`, and `max_bytes` with an inline example.
...
**Files**: [src/tools/handlers/filesystem.ts](../../../../versions/src/tools/handlers/filesystem.ts), [src/tools/handlers/terminal.ts](../../../../versions/src/tools/handlers/terminal.ts), [src/tools/handlers/webSearch.ts](../../../../versions/src/tools/handlers/webSearch.ts), [src/tools/OutputRedirector.ts](../../../../versions/src/tools/OutputRedirector.ts), [src/tools/ToolRegistry.ts](../../../../versions/src/tools/ToolRegistry.ts)
...
**Files**: [tests/unit/tools/null-safety.test.ts](../../../../versions/tests/unit/tools/null-safety.test.ts), [src/tools/handlers/filesystem.ts](../../../../versions/src/tools/handlers/filesystem.ts) (defensive fix)
...
|------|------:|----------------|
| [tests/unit/tools/OutputRedirector.bytecap.test.ts](../../../../versions/tests/unit/tools/OutputRedirector.bytecap.test.ts) | 13 | `applyByteCap` UTF-8 boundary safety, tool-specific narrowing hints, override validation, truncation counters |
| [tests/unit/tools/handlers/filesystem.read_file.range.test.ts](../../../../versions/tests/unit/tools/handlers/filesystem.read_file.range.test.ts) | 7 | range pagination happy path, EOF marker, invalid range_start, range_end <= range_start, 1 MB window cap |
| [tests/unit/tools/handlers/filesystem.grep.pagination.test.ts](../../../../versions/tests/unit/tools/handlers/filesystem.grep.pagination.test.ts) | 7 | cursor round-trip, invalid base64 cursor, non-string cursor, max_results clamp warning, max_results <= 0 |
| [tests/unit/tools/errors.test.ts](../../../../versions/tests/unit/tools/errors.test.ts) | 24 + meta | programmatic error scenarios across all handlers + AST meta-test that walks 5 source files and rejects any `error: ...` literal missing `Usage:` |
| [tests/unit/tools/null-safety.test.ts](../../../../versions/tests/unit/tools/null-safety.test.ts) | 88 | 8 handlers x 11 pathological inputs |
| [tests/integration/tool-output-bytecap.test.ts](../../../../versions/tests/integration/tool-output-bytecap.test.ts) | 5 | end-to-end through `ToolRegistry.execute`: cap fires on 200 KB output, `max_bytes` override raises ceiling, invalid override returns actionable error |
...
| File | Status |
|------|--------|
| [src/tools/OutputRedirector.ts](../../../../versions/src/tools/OutputRedirector.ts) | Modified -- added byte-cap module + helper-tool error rewrites |
| [src/tools/ToolRegistry.ts](../../../../versions/src/tools/ToolRegistry.ts) | Modified -- byte-cap integration + error rewrites |
| [src/tools/ToolCatalog.ts](../../../../versions/src/tools/ToolCatalog.ts) | Modified -- new schema parameters for read_file, grep_codebase |
| [src/tools/types.ts](../../../../versions/src/tools/types.ts) | Modified -- range_start, range_end, next_offset on params interfaces |
| [src/tools/handlers/filesystem.ts](../../../../versions/src/tools/handlers/filesystem.ts) | Modified -- pagination + walkDir fix + error rewrites |
| [src/tools/handlers/terminal.ts](../../../../versions/src/tools/handlers/terminal.ts) | Modified -- error rewrites |
| [src/tools/handlers/webSearch.ts](../../../../versions/src/tools/handlers/webSearch.ts) | Modified -- error rewrites |
| [tests/unit/tools/OutputRedirector.bytecap.test.ts](../../../../versions/tests/unit/tools/OutputRedirector.bytecap.test.ts) | Added |
| [tests/unit/tools/handlers/filesystem.read_file.range.test.ts](../../../../versions/tests/unit/tools/handlers/filesystem.read_file.range.test.ts) | Added |
| [tests/unit/tools/handlers/filesystem.grep.pagination.test.ts](../../../../versions/tests/unit/tools/handlers/filesystem.grep.pagination.test.ts) | Added |
| [tests/unit/tools/errors.test.ts](../../../../versions/tests/unit/tools/errors.test.ts) | Added |
| [tests/unit/tools/null-safety.test.ts](../../../../versions/tests/unit/tools/null-safety.test.ts) | Added |
| [tests/integration/tool-output-bytecap.test.ts](../../../../versions/tests/integration/tool-output-bytecap.test.ts) | Added |
| [docs/DEVLOG.md](../../../../versions/v0/DEVLOG.md) | Updated -- Phase 2 entry prepended |
