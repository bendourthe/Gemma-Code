...
**Files**:
- [src/storage/MemoryHealthCheck.ts](../../../../versions/src/storage/MemoryHealthCheck.ts) (357 lines; new module)
- [src/commands/memoryLintCommand.ts](../../../../versions/src/commands/memoryLintCommand.ts) (128 lines; slash-command handler)
- [src/commands/CommandRouter.ts](../../../../versions/src/commands/CommandRouter.ts) (route `/memory lint` to the new handler)
- [src/panels/GemmaCodePanel.ts](../../../../versions/src/panels/GemmaCodePanel.ts) (compose `MemoryHealthCheck` against the live `MemoryStore`)
...
**Files**:
- [src/storage/MemoryStore.ts](../../../../versions/src/storage/MemoryStore.ts) (idempotent migration block keyed off `PRAGMA user_version`)
- [src/storage/MemoryStore.types.ts](../../../../versions/src/storage/MemoryStore.types.ts) (`MemorySearchResult.corroborationTier: 'fact' | 'candidate'`)
...
**Files**:
- [src/config/settings.ts](../../../../versions/src/config/settings.ts) (`gemma-code.memoryCorroborationThreshold`, range 1-5, default 2)
- [src/storage/MemoryConsolidator.ts](../../../../versions/src/storage/MemoryConsolidator.ts) (`addObservation(...)` with counter exposure)
- [src/storage/MemoryStore.ts](../../../../versions/src/storage/MemoryStore.ts) (`retrieve(query, budget, threshold?)` partitions tiers)
- [src/storage/UnifiedMemoryRetriever.ts](../../../../versions/src/storage/UnifiedMemoryRetriever.ts) (rank fact-tier rows above candidate-tier rows)
- [src/storage/MemorySubsystem.ts](../../../../versions/src/storage/MemorySubsystem.ts) (composition root wires the threshold into the consolidator + retriever)
...
**Files**:
- [tests/unit/storage/MemoryStore.migration.test.ts](../../../../versions/tests/unit/storage/MemoryStore.migration.test.ts)
- [tests/unit/storage/MemoryHealthCheck.test.ts](../../../../versions/tests/unit/storage/MemoryHealthCheck.test.ts)
- [tests/unit/storage/MemoryConsolidator.corroboration.test.ts](../../../../versions/tests/unit/storage/MemoryConsolidator.corroboration.test.ts)
- [tests/unit/commands/memoryLintCommand.test.ts](../../../../versions/tests/unit/commands/memoryLintCommand.test.ts)
- [tests/integration/memory-lint-end-to-end.test.ts](../../../../versions/tests/integration/memory-lint-end-to-end.test.ts)
- [tests/golden/tasks/memory-hygiene-missed-fact-01.yaml](../../../../versions/tests/golden/tasks/memory-hygiene-missed-fact-01.yaml)
- [tests/golden/baselines/v0.5.0+memory-hygiene.json](../../../../versions/tests/golden/baselines/v0.5.0+memory-hygiene.json)
- [tests/golden/snapshots/memory-hygiene-missed-fact-01/](../../../../versions/tests/golden/snapshots/memory-hygiene-missed-fact-01)
