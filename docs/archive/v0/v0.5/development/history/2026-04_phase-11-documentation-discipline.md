...
| # | Sub-task | Output |
|---|----------|--------|
| 11.1 | ADR-0002 memory subsystem layering | [docs/adr/0002-memory-subsystem-layering.md](../../../../versions/v0/adr/0002-memory-subsystem-layering.md) |
| 11.2 | ADR-0003 compaction strategy ordering | [docs/adr/0003-compaction-strategy-ordering.md](../../../../versions/v0/adr/0003-compaction-strategy-ordering.md) |
| 11.3 | ADR-0004 sub-agent isolation contract | [docs/adr/0004-sub-agent-isolation-contract.md](../../../../versions/v0/adr/0004-sub-agent-isolation-contract.md) |
| 11.4 | ADR-0005 tool permission tiers | [docs/adr/0005-tool-permission-tiers.md](../../../../versions/v0/adr/0005-tool-permission-tiers.md) |
| 11.5 | Mermaid module-dependency diagram | New `## Module Dependency Graph` section in [ARCHITECTURE.md](../../../../versions/ARCHITECTURE.md) |
| 11.6 | Module Authorship Contract in AGENTS.md | [AGENTS.md](../../../../versions/AGENTS.md) `## Module Authorship Contract` (replaces placeholder) |
| 11.7 | Refactor / characterization-test playbook | [docs/refactor-playbook.md](../../../../versions/v0/refactor-playbook.md), cross-referenced from [CONTRIBUTING.md](../../../../versions/CONTRIBUTING.md) and [test-pyramid.md](../../test-pyramid.md) |
| 11.8 | docs/issues template | [docs/issues/_template.md](../../../../versions/v0/issues/_template.md) + new "Issue records" section in CONTRIBUTING.md |
...
| 11.10 | Document `get_tool_schema` | New `## Tool Catalogue and Help Discovery` section in [ARCHITECTURE.md](../../../../versions/ARCHITECTURE.md), short paragraphs in [AGENTS.md](../../../../versions/AGENTS.md) and [README.md](../../../../versions/README.md), "Adding a new tool" reminder in [CONTRIBUTING.md](../../../../versions/CONTRIBUTING.md) |
| 11.11 | Auto-generated `docs/index.md` catalog | [scripts/generate-catalog.mjs](../../../../versions/scripts/generate-catalog.mjs), [docs/index.md](../../../../versions/v0/index.md), CI catalog-sync job in [.github/workflows/ci.yml](../../../../versions/.github/workflows/ci.yml), `npm run catalog` / `npm run catalog:check` scripts |
| 11.12 | `.github/CODEOWNERS` | [.github/CODEOWNERS](../../../../versions/.github/CODEOWNERS) with default + security-path owners; documented in CONTRIBUTING.md |
| 11.13 | Branch-cleanup workflow | [.github/workflows/branch-cleanup.yml](../../../../versions/.github/workflows/branch-cleanup.yml) (workflow_dispatch + weekly Sunday cron, dry-run during rollout) |
...
The four ADRs codify decisions that were made and shipped in v0.2.0-v0.5.0 but had no durable record outside the implementation plans. Each follows [docs/adr/template.md](../../../../versions/v0/adr/template.md): Status / Deciders / Context / Decision / Consequences / Alternatives / Links.
...
The [docs/adr/README.md](../../../../versions/v0/adr/README.md) index gained four rows in numeric order with the 2026-04-26 date.
