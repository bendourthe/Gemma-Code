...
**Created**: 2026-04-24
**Source Comparison**: [docs/archive/versions/v0/v0.5.0/comparison/comparison-7-principles-for-agent-friendly-clis.md](../comparison/comparison-7-principles-for-agent-friendly-clis.md)
...
| 4 | Documentation + severity rubric | Blocker / Friction / Optimization rubric documented in `docs/archive/versions/v0/v0.5.0/tool-audit.md`; `get_tool_schema` documented in `ARCHITECTURE.md` | P2-1, P3-2 |
...
>
> Constraints:
> - The cap interacts with Brotli compression (from the parallel token-optimizer-adoption Phase 1). The cap applies to the **uncompressed** output before any compression. Verify by reading both Phase 1 files of `docs/archive/versions/v0/v0.5.0/plans/token-optimizer-adoption.md` and `docs/archive/versions/v0/v0.5.0/plans/agent-friendly-tools.md`.
...
**Prompt**:
> Generate and run comprehensive tests for Phase 1 of the agent-friendly-tools adoption (`docs/archive/versions/v0/v0.5.0/plans/agent-friendly-tools.md`). Specifically:
>
...
**Stability Gate**: `docs/archive/versions/v0/v0.5.0/tool-audit.md` exists with the rubric definitions and an audit table covering every tool; `ARCHITECTURE.md` and `README.md` reference `get_tool_schema` as the help-discovery surface; the 3-task golden micro-eval at `tests/golden/tasks/agent-friendly/` passes (the agent uses the truncation hint to recover).

### Sub-tasks

#### 4.1 — Severity rubric document

**Objective**: Add `docs/archive/versions/v0/v0.5.0/tool-audit.md` with the Blocker / Friction / Optimization labels defined and an audit table covering every tool.

**Prompt**:
> Gemma Code v0.5.0 agent-friendly-tools adoption — Phase 4 step 1.
>
> Create `docs/archive/versions/v0/v0.5.0/tool-audit.md` with sections:
>
...
>
> 4. **References**: link to `docs/archive/versions/v0/v0.5.0/comparison/comparison-7-principles-for-agent-friendly-clis.md` and Trevin Chow's article URL.
>
> Cross-reference from `CONTRIBUTING.md` "Testing" section and from `docs/archive/versions/v0/v0.5.0/test-pyramid.md`.
>
> Constraints:
...
>    - Document the tool in `docs/archive/versions/v0/v0.5.0/tool-audit.md` (severity row).
>    - Add a usage hint in any error message per Phase 2's convention.
>
> Constraints:
> - Cross-link liberally between `ARCHITECTURE.md`, `README.md`, `CONTRIBUTING.md`, and `docs/archive/versions/v0/v0.5.0/tool-audit.md`.
...
> 5. Manually verify all docs render correctly (`docs/archive/versions/v0/v0.5.0/tool-audit.md`, `ARCHITECTURE.md`, `README.md`, `CONTRIBUTING.md`).
...
- [ ] `docs/archive/versions/v0/v0.5.0/tool-audit.md` published with severity rubric + audit table
