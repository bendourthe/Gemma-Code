...
| What | Source | Target | Effort | Dependencies | Risk |
|------|--------|--------|--------|--------------|------|
| Adopt the Blocker / Friction / Optimization rubric for tool-handler audit notes; tag any new tool ticket with one of the three | Principle 8 (severity rubric) | Add a "Severity rubric" section to `docs/archive/versions/v0/v0.4.0/test-pyramid.md` or a new `docs/archive/versions/v0/v0.4.0/tool-audit.md` | Low | None | Low — pure documentation |
