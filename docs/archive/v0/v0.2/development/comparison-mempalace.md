...
| **Architecture docs** | `docs/archive/versions/v0/v0.1.0/architecture.md` (system diagrams, component flow) | In-README only (palace metaphor explanation) |
| **API documentation** | `docs/archive/versions/v0/v0.1.0/tool-protocol.md` (tool-call XML format, agent loop) | MCP tool descriptions in `mcp_server.py` docstrings |
| **Security audit** | `docs/archive/versions/v0/v0.1.0/security-audit.md` (formal audit with findings) | None |
| **Testing guide** | `docs/archive/versions/v0/v0.1.0/testing.md` (tier breakdown, running instructions) | In CONTRIBUTING.md (brief pytest instructions) |
| **Development history** | 8 phase-specific documents in `docs/archive/versions/v0/v0.1.0/development/history/` | None |
...
| **Benchmark docs** | `docs/archive/versions/v0/v0.1.0/performance-benchmarks.md` | `benchmarks/README.md` (reproduction methodology, 3 benchmark suites) |
| **CI setup guide** | `docs/archive/versions/v0/v0.1.0/ci-setup.md` | None |
