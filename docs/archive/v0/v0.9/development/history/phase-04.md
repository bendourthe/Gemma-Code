...
Wrote five thin sibling delegates ([scripts/debug/unit.mjs](../../../../versions/scripts/debug/unit.mjs), [integration.mjs](../../../../versions/scripts/debug/integration.mjs), [golden.mjs](../../../../versions/scripts/debug/golden.mjs), [bench.mjs](../../../../versions/scripts/debug/bench.mjs), [logs.mjs](../../../../versions/scripts/debug/logs.mjs)) each ~7 lines that import `main` from `./cli.mjs` and prepend the kind to `process.argv`. This is deliberately small surface so a contributor can invoke `node scripts/debug/unit.mjs` directly without the `npm run debug` indirection.

Added `"debug": "node scripts/debug/cli.mjs"` to [package.json](../../../../versions/package.json). Added `out/debug-logs/` to [.gitignore](../../../../versions/.gitignore) with a comment citing the sub-task.

Wrote [tests/unit/scripts/debug.test.ts](../../../../versions/tests/unit/scripts/debug.test.ts) with 14 tests:
...
Wrote [.github/workflows/coverage-diff.yml](../../../../versions/.github/workflows/coverage-diff.yml). Triggers on `pull_request: types: [opened, synchronize, reopened] branches: ["main"]` with concurrency group `coverage-diff-${{ github.head_ref || github.ref }}` and `cancel-in-progress: true`. Job runs on `ubuntu-latest` with `permissions: contents: read, pull-requests: write`.
...
Did NOT modify [configs/vitest.config.ts](../../../../versions/configs/vitest.config.ts) -- the global thresholds (`lines: 80, branches: 75`) stay as the suite-wide floor and `diff-cover` is purely additive on top.
...
Wrote [.husky/pre-push](../../../../versions/.husky/pre-push) as a POSIX shell script (runs on Git Bash on Windows + macOS / Linux). Five steps with explicit progress messages:
...
Added `"work": "node scripts/work.mjs"` to [package.json](../../../../versions/package.json).

Wrote [tests/unit/scripts/work.test.ts](../../../../versions/tests/unit/scripts/work.test.ts) with 18 tests:
...
Updated [docs/archive/versions/v0/v0.9.0/known-gaps.md](../../known-gaps.md): added 10.N.I (diff-cover live-PR smoke), 10.N.J (pre-push real-branch smoke), 10.N.K (Phase 4 atomic-commit deviation); migrated the suggested next step of 10.N.B and 10.N.C from Phase 4 to Phase 6 "UX polish" since Phase 4 was dev-loop only; recomputed the summary table (3 NI / 7 DF / 0 BG / 1 MT / 0 WN / 0 QG open; 0 / 9 / 3 / 2 / 0 / 0 resolved); appended the Phase 4 close status. Updated [docs/DEVLOG.md](../../../../versions/v0/DEVLOG.md) with a Phase 4 entry covering each sub-task's decisions and the test surface. Wrote this session history file.
...
### Added (10 files)
- [scripts/debug/cli.mjs](../../../../versions/scripts/debug/cli.mjs)
- [scripts/debug/unit.mjs](../../../../versions/scripts/debug/unit.mjs)
- [scripts/debug/integration.mjs](../../../../versions/scripts/debug/integration.mjs)
- [scripts/debug/golden.mjs](../../../../versions/scripts/debug/golden.mjs)
- [scripts/debug/bench.mjs](../../../../versions/scripts/debug/bench.mjs)
- [scripts/debug/logs.mjs](../../../../versions/scripts/debug/logs.mjs)
- [.github/workflows/coverage-diff.yml](../../../../versions/.github/workflows/coverage-diff.yml)
- [.husky/pre-push](../../../../versions/.husky/pre-push)
- [scripts/work.mjs](../../../../versions/scripts/work.mjs)
- [tests/unit/scripts/debug.test.ts](../../../../versions/tests/unit/scripts/debug.test.ts)
- [tests/unit/scripts/work.test.ts](../../../../versions/tests/unit/scripts/work.test.ts)
- [tests/integration/husky-prepush.test.ts](../../../../versions/tests/integration/husky-prepush.test.ts)
- [docs/archive/versions/v0/v0.9.0/development/history/phase-04.md](.) (this file)

### Modified
- [package.json](../../../../versions/package.json) -- added `"debug"` and `"work"` npm scripts.
- [.gitignore](../../../../versions/.gitignore) -- added `out/debug-logs/`.
- [docs/archive/versions/v0/v0.9.0/known-gaps.md](../../known-gaps.md) -- three new entries (10.N.I / 10.N.J / 10.N.K), two updated, summary + status.
- [docs/DEVLOG.md](../../../../versions/v0/DEVLOG.md) -- Phase 4 entry.
