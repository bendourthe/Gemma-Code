...
After every section flips to `done`, append a one-line note to [docs/archive/versions/v0/v0.8.0/known-gaps.md](../v0.8/known-gaps.md) Section 10.2 (Resolved) for the matching `10.O.<X>` entry with `Resolved in: v0.9.0 operator-actions Section <N>`, and recompute the Section 10.3 Summary counts.
