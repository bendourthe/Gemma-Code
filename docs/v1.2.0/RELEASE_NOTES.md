...
**Plan**: [docs/v1.2.0/plans/adoption-ecosystem-2026-05.md](plans/adoption-ecosystem-2026-05.md)
**Known gaps**: [docs/v1.2.0/known-gaps.md](known-gaps.md)
...
29 open items remain in [docs/v1.2.0/known-gaps.md](known-gaps.md): 12 P2 + 17 P3. None are release blockers (zero P0 / P1). The largest deferrals:
