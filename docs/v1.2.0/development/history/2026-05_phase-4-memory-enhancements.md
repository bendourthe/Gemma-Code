...
[docs/v1.2.0/plans/adoption-ecosystem-2026-05.md](../../plans/adoption-ecosystem-2026-05.md) Phase 4. Non-final phase (4 of 7); Phase 9 release-readiness workflow does NOT run. Prerequisite: Phase 3 complete (commit `5b63989`).
...
Updated `docs/v1.2.0/known-gaps.md` `## 3. Summary` -- 14 open items (was 9), severity P1: 0, P2: 6, P3: 8.
...
docs/v1.2.0/development/history/2026-05_phase-4-memory-enhancements.md   (this file)
```
...
docs/v1.2.0/known-gaps.md               (Phase 4 entries appended; summary recomputed)
...
- **Phase 7.2** (Storage-size benchmark): run the canonical 100k-chunk variant with the real transformer embedder; publish under `docs/v1.2.0/benchmarks/memory-storage-size-2026-05-26.md`.
