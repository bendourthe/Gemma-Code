...
The anchor row for 24 GB / ~40 tok/s comes from the jola.dev M4 multi-source comparison ([docs/v0.7.0/comparison-multi-source-v2.md](../v0.7.0/comparison-multi-source-v2.md) item F6).
