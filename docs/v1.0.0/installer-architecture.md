...
| Sub-task | New file(s) |
|---|---|
| 9.1 (this doc) | [docs/v1.0.0/installer-architecture.md](installer-architecture.md), [scripts/installer/build/windows-pipeline.md](../../scripts/installer/build/windows-pipeline.md), [.github/workflows/installer-build.yml](../../.github/workflows/installer-build.yml) |
...
| 9.8 (macOS / Linux) | [docs/v1.0.0/installer-macos-and-linux.md](installer-macos-and-linux.md), [.github/workflows/installer-macos.yml](../../.github/workflows/installer-macos.yml), [.github/workflows/installer-linux.yml](../../.github/workflows/installer-linux.yml) |
| 9.9 (Tests) | new tests under [scripts/installer/pyqt/tests/](../../scripts/installer/pyqt/tests/) and [docs/v1.0.0/installer-smoke-checklist.md](installer-smoke-checklist.md) |

## Sibling references

- [docs/v1.0.0/architecture.md](architecture.md) -- v1.0.0 system architecture
- [docs/v1.0.0/plans/phase-09-installer.md](plans/phase-09-installer.md) -- the active plan
- [docs/v1.0.0/pivot-brief.md](pivot-brief.md) -- the strategic context for v1.0.0
