...
1. This pivot brief.
2. The two `/compare-project` outputs (ComfyUI, DevAI-Hub) that will land in `docs/v1.0.0/comparison-comfyui.md` and `docs/v1.0.0/comparison-devai-hub.md`.
3. The current state of `src/` (Gemma Code engine).
4. The latest known-gaps from `docs/v0.9.0/known-gaps.md` (any unresolved items roll forward).
5. The UI mockup described in section 3.

Output: `docs/v1.0.0/plans/v1.0.0-cycle.md` with sub-plans per phase under `docs/v1.0.0/plans/<phase-slug>.md`.
