...
**Plan**: [docs/v1.0.0/plans/phase-03-coding-module.md](../../plans/phase-03-coding-module.md)
...
See [docs/v1.0.0/known-gaps.md](../../known-gaps.md) sections `3.P1.M` ... `3.P2.U` for the structured list.
