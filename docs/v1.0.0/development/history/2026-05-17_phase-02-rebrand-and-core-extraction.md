...
**Plan**: [docs/v1.0.0/plans/phase-02-rebrand-and-core-extraction.md](../../plans/phase-02-rebrand-and-core-extraction.md)
...
- Created [`docs/v1.0.0/architecture.md`](../../architecture.md) as the v1.0.0 architecture document (referenced from `ARCHITECTURE.md`).
- Updated [`docs/v1.0.0/pivot-brief.md`](../../pivot-brief.md) Section 7 ("Repository-wide rebrand scope") to move Phase 2 deliverables from "deferred" to "completed".
...
docs/v1.0.0/development/history/2026-05-17_phase-02-rebrand-and-core-extraction.md
