...
|---|---|---|
| 11.1 Deep review | `docs/v1.0.0/review/synthesis.md` | green |
| 11.2 Security audit | `docs/v1.0.0/review/security-audit.md` -- zero P0 / P1 | green |
| 11.2 Pen-test (depth=deep) | `docs/v1.0.0/review/penetration-test.md` -- zero P0 / P1 | green |
| 11.3 Authenticode signing | `docs/v1.0.0/release-signing.md` (Section 1 Windows, Section 2 macOS) | docs ready; OA-01 pending |
| 11.4 CHANGELOG | `CHANGELOG.md` v1.0.0 entry with full Added / Changed / Deprecated / Removed / Fixed / Security sections | green |
| 11.4 Release notes | `docs/v1.0.0/release-notes.md` user-facing announcement | green |
| 11.5 Version bump | 6 version-carrying files updated to `1.0.0`; NSIS already at `1.0.0` | green |
| 11.6 RTM smoke | `docs/v1.0.0/rtm-smoke.md` procedure | docs ready; OA-04 pending |
| 11.7 Distribution channels | `docs/v1.0.0/distribution.md` (GitHub Releases + VS Code Marketplace + landing page) | green |
| 11.8 Finalize known-gaps | `docs/v1.0.0/known-gaps.md` flipped to `finalized`; v0.9.0 also flipped | green |
...
- `docs/v1.0.0/release-notes.md` -- user-facing release announcement.
- `docs/v1.0.0/release-signing.md` -- Authenticode (Windows) + notarization (macOS) workflow.
- `docs/v1.0.0/rtm-smoke.md` -- RTM smoke checklist (12 steps + recording template).
- `docs/v1.0.0/distribution.md` -- distribution channel runbook.
- `docs/v1.0.0/operator-actions.md` -- consolidated operator checklist OA-01 through OA-12.
- `docs/v1.0.0/review/synthesis.md` -- deep-review synthesis.
- `docs/v1.0.0/review/security-audit.md` -- defensive sweep.
- `docs/v1.0.0/review/penetration-test.md` -- 6-specialist OWASP WSTG offensive pass.
- `docs/v1.0.0/development/history/2026-05-18_phase-11-hardening-and-release.md` -- this file.
...
- `docs/v1.0.0/known-gaps.md` -- Status flipped to `finalized at v1.0.0 release (Phase 11.8, 2026-05-18)`. Added: 6 new Phase 11 entries (11.P1.LLL, 11.P1.MMM, 11.P2.NNN, 11.P2.OOO, 11.P2.PPP, 11.P1.QQQ). Resolved table extended with 3 v0.9.0 closures (10.N.A, 10.N.Q, 10.N.R, 10.N.T already noted; 10.N.T added explicitly) + 11.P0.RRR + 11.P0.SSS + 11.P1.QQQ. Summary table recomputed. New `## 4. Phase 11 carryforward map` triages every open item to operator-actions.md (15 items), v1.1.0 (47 items), or specific future cycles (4 items).
- `docs/v0.9.0/known-gaps.md` -- Status flipped to `finalized at v1.0.0 release (Phase 11.8, 2026-05-18)`. Closure note references the four items closed in the v1.0.0 cycle and points to `docs/v1.0.0/known-gaps.md` Section 2 for full disposition of remaining open items.
...
No P0 / P1 defects remain in-cycle. Architectural carryforward (47 items, see `docs/v1.0.0/known-gaps.md` Section 4.2) maps cleanly to a single v1.1.0 phase that introduces the shared-core build / `@nexus/core` workspace package. Operator-driven carryforward (15 items, see Section 4.1) maps to `docs/v1.0.0/operator-actions.md`.
