...
**Date**: 2026-05-17
**Plan**: [docs/v1.0.0/plans/phase-07-video-lab.md](../../plans/phase-07-video-lab.md)
...
8. **Operator acceptance on real GPU rig deferred** (known-gap `7.P3.TT`). The <= 5 minute LTX-Video / <= 4 minute SVD timing targets are operator actions documented in `docs/v1.0.0/operator-actions.md` once that file is opened (currently scheduled for Phase 11).
