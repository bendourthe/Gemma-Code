...
**Recording**: append the result, the wall-clock timings, and any anomalies to `docs/v1.0.0/operator-actions.md` (Section: "OA-04 RTM smoke execution").
...
Append to `docs/v1.0.0/operator-actions.md` under "OA-04 RTM smoke execution":
...
Any anomalies become P3 known-gaps for v1.0.1, recorded in `docs/v1.0.1/known-gaps.md` once that file opens.
