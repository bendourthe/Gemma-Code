...
**Mode:** audit
**Scope:** `docs/v1/v1.18/` plus Phase 6 edits under `ARCHITECTURE.md`, `README.md`, `SECURITY.md`, `AGENTS.md`, `docs/install.md`, `docs/todos.md`, and `docs/DEVLOG.md` (implement-phase 8.5; no files moved)

This phase created no scratch docs. No files were moved or deleted. The Windows enforcement matrix lives in-module (`modules/coding/sandbox/windowsMatrix.ts`), not as a separate docs file. Session history is a new Cat 4 file under the version directory.
...
|---|---|---|---|---|
| docs/v1/v1.18/plans/v1.18.0-adoption-agent-harness-and-governance.md | Cat 4 | active version | (keep) | Cycle plan; Phase 6 exit checklist ticked; Phase 4 still open |
...
| docs/v1/v1.18/known-gaps.md | Cat 4 | active version | (keep) | Appended Phase 6 DF-11; EM.P5.A resolved per OS |
...
| docs/v1/v1.18/development/history/2026-08-17_phase-6-os-process-sandbox.md | Cat 4 | active version | (keep) | Phase 6 session history |
...
No moves proposed. Default is leave as-is. The Windows FS/network honesty table is `modules/coding/sandbox/windowsMatrix.ts` plus `SECURITY.md`. Do not add a parallel markdown copy.
