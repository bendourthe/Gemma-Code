...
| Large-MoE / offload runtime | Patient/offload tier (gated) | `core/registry/patientTier.ts`; `docs/v1/v1.12/known-gaps.md:39` |
...
- **N3 -- Opening the EM.P3 or EM.P4 gates specifically to ship Laguna ahead of independent benchmarks.** **Rejected / gated** (the v1.12 roadmap requires runtime support and independent benchmarks confirmed before flipping the gate, `docs/v1/v1.12/known-gaps.md:31-39`; premature enablement is an OOM/latency risk).
