...
|---|---|---|---|---|
| docs/v1/v1.19/plans/v1.19.0-adoption-liquid-lfm-agentic.md | Cat 4 | active version | (keep) | Cycle plan; Phase 1 exit checklist ticked |
...
| docs/v1/v1.19/known-gaps.md | Cat 4 | active version | (keep) | Created this phase; 5 DF |
