...
**Mode:** audit
**Scope:** `docs/v1/v1.17/` (Phase 2 of implement-phase; `--keep-current-version` ON)
...
|---|---|---|---|---|
| docs/v1/v1.17/plans/v1.17.0-adoption-ui-motion-identity.md | Cat 4 | active version, filename pattern | (keep) | In-flight plan; Phase 2 exit checked |
...
| docs/v1/v1.17/design-tokens.md | Cat 4 | active version | (keep) | Added Phase 2 mapping table |
| docs/v1/v1.17/development/history/2026-08_phase-1-motion-foundation.md | Cat 4 | active version | (keep) | Phase 1 history |
| docs/v1/v1.17/development/history/2026-08_phase-2-agent-state-orbs.md | Cat 4 | active version | (keep) | Created this phase |
