...
```
Implement Nexus AI Studio v2.2.2 from docs/v2/v2.2/plans/v2.2.2-ready-shell-and-studio-chrome.md. Follow AGENTS.md. Do not re-run v2.2.0 or v2.2.1. Close what the post-healthcheck GUI session still proves broken, and finish composer / bubble / Data / Advanced chrome.
