...
| Scheduling | No user-facing scheduler (A2 in the v1.18.0 OpenWorker comparison, `docs/v1/v1.18/comparisons/v1.18.0-comparison-openworker.md`) | Cron schedules, deferred turns, webhooks | Reconfirms the A2 gap; webhooks are an inbound surface Nexus should not take |
