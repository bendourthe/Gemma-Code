...
**Date**: 2026-08-20
**Plan**: [plans/v2.1.0-adoption-open-local-ai-wave.md](plans/v2.1.0-adoption-open-local-ai-wave.md) Phase 5.5

Extends [v2.0 hardware gates](../v2.0/ci-hardware-gates.md). GitHub Actions still does not install GPU weights or CUDA. Fine-tuning live Unsloth is a local-only path.
