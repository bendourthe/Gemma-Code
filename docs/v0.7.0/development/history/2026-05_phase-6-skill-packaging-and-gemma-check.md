...
**Comparison reference**: [docs/v0.7.0/comparison-multi-source.md](../../comparison-multi-source.md) C29, C30
...
- `docs/v0.7.0/architecture.md` -- expanded sections 5 (Multi-harness skill packaging) and 6 (gemma-check CLI) with full per-rule and per-harness tables.
...
- `docs/v0.7.0/known-gaps.md` -- four new in-cycle gap rows (10.O.7 through 10.O.10) and recomputed Section 10.3 summary.
