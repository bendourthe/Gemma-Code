...
**Sibling**: [docs/v0.7.0/comparison-multi-source.md](comparison-multi-source.md) (v0.5.5-era pass, used to seed v0.7.0)
...
| Pen test | `docs/v0.6.0/review/penetration-test.md` | (none committed) | (none) | (none) | (none) | (none) |
...
- `docs/v0.8.0/{plans/v0.8.0-cycle.md, review/evaluator-rubric.md}` (new templates)
