...
**Objective**: Close every P0 finding from the v0.3.0 code review (docs/v0.3.0/review.md) so a release is no longer blocked, bump the project to 0.4.0, and seed the CHANGELOG for the remediation cycle.
...
- **Plan reference**: [docs/v0.4.0/implementation-plan.md](../../implementation-plan.md); scratch plan at `~/.claude/plans/1-of-v0-4-0-velvety-globe.md`
