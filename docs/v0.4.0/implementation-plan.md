...
**Version**: 0.4.0
**Created**: 2026-04-16
**Goal**: Close every one of the 129 findings from [docs/v0.3.0/review.md](../v0.3.0/review.md) across seven phases, ending with a stabilized v0.4.0 release tag, cleaner architecture, a regression-gated test pipeline, and ~800 LOC of dead-code removed.
...
**Prompt**:
> Context: Addresses review finding #1 (P0 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review finding #2 (P0 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review finding #3 (P0 correctness) in `docs/v0.3.0/review.md` section 3.1.
...
**Prompt**:
> Context: Addresses review finding #4 (P0 correctness) in `docs/v0.3.0/review.md` section 3.1.
...
**Prompt**:
> Context: Addresses review finding #5 (P0 correctness) in `docs/v0.3.0/review.md` section 3.1.
...
**Prompt**:
> Context: Addresses review finding #6 (P0 performance) in `docs/v0.3.0/review.md` section 3.3.
...
**Prompt**:
> Context: Addresses review finding #7 (P0 performance) in `docs/v0.3.0/review.md` section 3.3.
...
**Prompt**:
> Context: Addresses review finding #8 (P0 testing) in `docs/v0.3.0/review.md` section 3.4.
...
**Prompt**:
> Context: Addresses review finding #9 (P0 testing) in `docs/v0.3.0/review.md` section 3.4.
...
**Prompt**:
> Context: Addresses review finding #10 (P0 testing) in `docs/v0.3.0/review.md` section 3.4.
...
**Prompt**:
> Context: Addresses review finding #11 (P0 testing) in `docs/v0.3.0/review.md` section 3.4.
...
**Prompt**:
> Context: Addresses review finding #12 (P0 testing) in `docs/v0.3.0/review.md` section 3.4.
...
**Prompt**:
> Context: Addresses review finding #13 (P0 restructuring) in `docs/v0.3.0/review.md` section 3.5 (6a P1 / 6b P0). A full restructuring decision was made during plan approval: delete the Python backend because no TS consumer ever reads `baseUrl`.
...
**Prompt**:
> Context: Addresses review finding #14 (P0 restructuring) in `docs/v0.3.0/review.md` section 3.5 (6b P0). Full split completes in Phase 6; this is the smallest-blast-radius first slice.
...
**Prompt**:
> Context: Addresses review finding #22 (P1 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review finding #24 (P1 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review findings #25 and #27 (P1 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review finding #26 (P1 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review finding #75 (P2 security) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses review finding (dep audit gap) in `docs/v0.3.0/review.md` section 3.2.
...
**Prompt**:
> Context: Addresses finding #15 (P1 correctness) in `docs/v0.3.0/review.md` section 3.1.
...
**Prompt**:
> Context: Addresses finding #16 (P1 correctness) in `docs/v0.3.0/review.md` section 3.1.
...
**Prompt**:
> Run `npm run test`, `pytest`, `npm run bench`. Confirm coverage >= 80% / 75%. Measure current pyramid ratio (unit/integration/e2e) and record in `docs/v0.4.0/test-pyramid.md`. Fix every failure. Run `/generate-session-history` for Phase 5.
...
> Goal: `docs/adr/0001-python-backend-disposition.md` using MADR format documents the rationale for deletion (or retention, whichever was chosen). Update `docs/v0.3.0/architecture.md` to note the change.
...
Finding # references the P0 list in [docs/v0.3.0/review.md](../v0.3.0/review.md) Section 4 (items 1-60) plus the grouped P2/P3 findings from Section 3.
...
2. Open this file: `docs/v0.4.0/implementation-plan.md`.
