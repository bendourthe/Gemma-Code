...
| v1.6.0 | aisuite harness adoptions + Nexus-AI interactive guide (H1 guide, A4 session viewer, A1 dehydration, A2 trace nesting, A3 adapter registry) | **Phase 1 closed 2026-06-15** (H1 interactive guide: AS001/AS002 delivered 2026-06-14, AS003 offline-integrity test closed 2026-06-15); Phases 2-6 pending | `versions/v1/v1.6.0/plans/adoption-aisuite-harness.md` |
