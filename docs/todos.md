...
| v1.6.0 | aisuite harness adoptions + Nexus-AI interactive guide (H1 guide, A4 session viewer, A1 dehydration, A2 trace nesting, A3 adapter registry) | **Phases 1-4 closed 2026-06-15** (H1 interactive guide AS001-AS003; A4 session/trace viewer AS004; A1 session-state artifact dehydration AS005; A2 hierarchical sub-run trace nesting AS006); Phase 5 (A3 adapter registry, backlog/demand-gated) + Phase 6 FINAL pending | `versions/v1/v1.6.0/plans/adoption-aisuite-harness.md` |
