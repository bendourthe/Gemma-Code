...
**Predecessor**: [../../v1.4.0/development/nexus-hub-integration-delta.md](../../v1.4.0/development/nexus-hub-integration-delta.md) (the v1.4.0 Phase 9 delta, which inventoried the Hub surfaces and routed the net-new ones to v1.5.0 as `HUB.P3.*`)
**Wording convention**: follows [../../v1.4.0/development/evidence-and-support-tiers.md](../../v1.4.0/development/evidence-and-support-tiers.md) (A7). `integrated` cites runtime-consuming code; `not-integrated` means "not proven wired here", not "impossible". "not_observed != absent" applies.
