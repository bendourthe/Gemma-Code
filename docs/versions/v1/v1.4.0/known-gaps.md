...
**Last updated**: 2026-05-31 (Phase 6 -- parallel agent execution)
...
| T020-T031 | architectural / wiring carryforward | Pending | Phases 7-8 (code-shaped) |
...
| Bucket | Count |
|---|---|
| Open items introduced by v1.4.0 phases so far | 3 (`T016.P3.A` A8 hook daemon wiring; `T018.P3.A` A10 runtime wiring; `T018.P3.B` A10 read-tool rooting / team orchestration -- all P3/DF) |
| Carryforward open items (v1.1.0 / v1.2.0 / v1.3.0, resolved in Phases 7-9) | 36 |
| Resolved this cycle | 12 (A3, A7, A12, A11, A4, A5, A2, A9, A1, A6, A8, A10) |
| Adoption items landed (of 12) | 12 (A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12) |

**Phase 6 status**: complete. All 12 adoption items (A1-A12) now landed. No release-blocker open; two new P3/DF items (`T018.P3.A` runtime wiring, `T018.P3.B` read-tool rooting / team orchestration) join `T016.P3.A` as opt-in/wiring deferrals. The `T018.P3.A` runtime wiring naturally pairs with the `T016.P3.A` daemon-wiring work in Phase 8 (T027). Next: Phase 7 (architectural carryforward -- src->modules/coding move, TS project refs, Tree-sitter swap, HNSW).
