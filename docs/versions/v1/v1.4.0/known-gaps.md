...
**Last updated**: 2026-05-30 (Phase 3 -- static-analysis & CI gates)
...
| T012-T031 | A1, A6, A8, A10 + architectural / wiring carryforward | Pending | Phases 4-8 (code-shaped) |
...
| Resolved this cycle | 8 (A3, A7, A12, A11, A4, A5, A2, A9) |
| Adoption items landed (of 12) | 8 (A2, A3, A4, A5, A7, A9, A11, A12) |

**Phase 3 status**: complete. No release-blocker open; no new gap introduced. Next: Phase 4 (safety config SSOT, A1).
