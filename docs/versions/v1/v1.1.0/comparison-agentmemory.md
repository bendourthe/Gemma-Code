...
**Companion reports**: [comparison-sana.md](comparison-sana.md); upstream comparison artifacts in [docs/versions/v1/v1.0.0/comparison-comfyui.md](../v1.0.0/comparison-comfyui.md) and [docs/versions/v1/v1.0.0/comparison-devai-hub.md](../v1.0.0/comparison-devai-hub.md).
