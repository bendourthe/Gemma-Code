...
- **install.md** ([docs/install.md](../../../../install.md)): freshened the release-provenance line to the v1.9.0 single-window flow (the single-installer flow, "Nexus AI Studio" naming, SmartScreen/Gatekeeper notes, and SHA256SUMS verification were already documented in Phase 1). The before/after screenshot archive rides the on-device operator rehearsal (no GUI surface here).
- **DEVLOG** ([docs/DEVLOG.md](../../../../DEVLOG.md)): Phase 6 close-out entry.
- **todos.md** ([docs/todos.md](../../../../todos.md)): the v1.9.0 cycle row added to the v1.x line table + the current-state header updated.
