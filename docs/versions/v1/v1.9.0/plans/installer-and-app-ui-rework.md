...
**Status**: PROPOSED -- authored from an operator review of the shipped v1.9.0 installer and app (screenshots dated 2026-07-06/07). Successor to [installer-and-app-experience-overhaul.md](installer-and-app-experience-overhaul.md) (COMPLETE), which delivered the single-artifact installer, brand foundation, and app overhaul; this cycle fixes the readability, animation-lag, icon, and copy issues that surfaced on the shipped build.
