...
**Companion reports**: [comparison-agentmemory.md](../v1.1.0/comparison-agentmemory.md); [comparison-sana.md](../v1.1.0/comparison-sana.md); upstream comparisons under [docs/versions/v1/v1.0.0/](../v1.0.0/).
...
**Why it matters for Nexus**: the Coding pillar's review surfaces, the Chat pillar's render path, the [session replay timeline](../v1.1.0/plans/phase-07-session-replay-timeline.md) (Phase 7, landed), and the operator-actions dashboard ([docs/versions/v1/v1.1.0/operator-actions.md](../v1.1.0/operator-actions.md)) are all places where HTML artifacts beat Markdown. Some of this is already happening (the Tauri shell renders HTML/React), but it is not codified as a behavior the Coding agent should choose by default.
