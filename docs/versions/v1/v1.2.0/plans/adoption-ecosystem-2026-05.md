...
**Carryforward note**: This adoption plan opens the v1.2.0 cycle, forward from the v1.1.0 closure on 2026-05-26 (Phase 15.9, see [docs/versions/v1/v1.1.0/known-gaps.md](../../v1.1.0/known-gaps.md)). Prior-version known-gaps from v1.0.0 are not re-ingested here -- they were already triaged in [docs/versions/v1/v1.1.0/known-gaps.md `## 4. Carryforward map`](../../v1.1.0/known-gaps.md) at v1.1.0 cycle close. The phases below are the v1.2.0 cycle's first adoption track; the Phase 7 known-gaps closure (sub-task 7.4) lands the adoption ledger under `docs/versions/v1/v1.2.0/known-gaps.md`.
