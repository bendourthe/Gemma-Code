...
The legacy [src/tools/handlers/preToolHook.ts](../../../../src/tools/handlers/preToolHook.ts) module is left in place per the AGENTS.md adjacent-scope rule but has no production callers. Tracked as `2.4.P2.E` in [docs/versions/v1/v1.2.0/known-gaps.md](../../known-gaps.md) for a follow-up cleanup commit.
