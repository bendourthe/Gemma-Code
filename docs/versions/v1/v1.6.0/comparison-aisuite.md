...
**Companion reports**: the active v1.5.0 cycle's forward-input ecosystem scan [comparison-ecosystem-2026-06.md](../v1.5.0/comparison-ecosystem-2026-06.md) (the source of the v1.5.0 plan); prior ecosystem scans under [docs/versions/v1/](../).
...
**Wording convention**: per [development/evidence-and-support-tiers.md](../v1.4.0/development/evidence-and-support-tiers.md), every claim about an *unbuilt* Nexus capability is stated at `candidate` or `future` tier, never `supported`; "not_observed != absent" applies. "Already implemented" classifications are grounded in the v1.5.0 [known-gaps.md](../v1.5.0/known-gaps.md), the [README.md](../../../../README.md)/[ARCHITECTURE.md](../../../../ARCHITECTURE.md) capability tables, and the per-subsystem code map taken for this report at `internal-compatible` confidence.
