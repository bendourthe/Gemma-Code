...
**Closes**: 9.P1.ZZ, 9.P1.AAA (via OA-06), 9.P2.BBB (via OA-07), 9.P1.CCC, 9.P2.DDD, 9.P2.EEE (macOS + Linux outer shells), 6.P1.HH, 7.P1.NN, 7.P1.OO from `docs/v1.0.0/known-gaps.md`.
...
> - Build the DMG via `create-dmg` with the layout from [docs/v1.0.0/installer-macos-and-linux.md](../../v1.0.0/installer-macos-and-linux.md)
>
