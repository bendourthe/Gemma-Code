...
This file mirrors the v1.0.0 [distribution.md](../v1.0.0/distribution.md) structure.
...
See CHANGELOG.md and docs/v1.1.0/release-notes.md for the full surface.
EOF
)"
```
...
The GitHub Release body is populated from [docs/v1.1.0/release-notes.md](release-notes.md) (the user-facing notes). The semantic-release plugin auto-generates a per-commit summary; the Phase 15.7 release-notes content overrides it via `.releaserc.json`'s `@semantic-release/github` plugin config.
...
- [docs/v1.0.0/distribution.md](../v1.0.0/distribution.md) -- v1.0.0 distribution structure this file mirrors.
- [docs/v1.0.0/operator-actions.md](../v1.0.0/operator-actions.md) -- OA-01 through OA-12 (signing, notarization, AppImage, landing page).
- [docs/v1.1.0/operator-actions.md](operator-actions.md) -- v1.1.0 extensions to OA-09 (SANA timings) + OA-V1.1.0-12A (SANA digest rotation).
- [docs/v1.1.0/marketplace-transition.md](marketplace-transition.md) -- Phase 10 Marketplace transition checklist (OA-V1.1.0-10A + OA-V1.1.0-10B).
- [docs/v1.1.0/release-notes.md](release-notes.md) -- v1.1.0 user-facing release notes.
- [docs/v1.1.0/known-gaps.md](known-gaps.md) -- v1.1.0 gap log (finalized at Phase 15.9).
