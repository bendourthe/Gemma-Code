...
- `docs/v0.8.0/known-gaps.md` -- 9 rows moved from Open to Resolved (K, M, S, T, U, V, W, Y, Z) with v0.9.0 Phase 2 references; Summary table recomputed.
- `docs/v0.9.0/known-gaps.md` -- 5 new in-cycle deferrals (10.N.A through 10.N.E), 9 newly-resolved rows from v0.8.0; Summary recomputed.
...
- [x] 10.O.K / M / S / T / U / V / W / Y / Z closed in `docs/v0.8.0/known-gaps.md` Section 10.2.
