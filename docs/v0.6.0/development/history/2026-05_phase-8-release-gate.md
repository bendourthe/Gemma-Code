...
- **Plan reference**: [docs/v0.6.0/plans/v0.6.0-cycle.md](../../plans/v0.6.0-cycle.md), Phase 8 (sub-tasks 8.1, 8.2, 8.3, 8.4, 8.5, 8.6)
...
**Key file changed**: [tests/benchmarks/context-compaction.bench.ts](../../../../tests/benchmarks/context-compaction.bench.ts).
...
**What happened**: Added `: void` return type to the `cb` callback at [src/config/GpuDetector.ts:18](../../../../src/config/GpuDetector.ts#L18). One line. `npm run lint` now reports zero errors, zero warnings.

### 2.3 Sub-task 8.2 -- Five ADRs

Wrote ADR-0006 through ADR-0010, modeled on [docs/adr/0005-tool-permission-tiers.md](../../../adr/0005-tool-permission-tiers.md):
...
| [0010](../../../adr/0010-threshold-elevation-decision.md) | Per-provenance semantic threshold elevation (heuristic vs. ollama) | v0.6.0 Phase 5 |

Updated [docs/adr/README.md](../../../adr/README.md) index with five new rows. Updated [docs/v0.5.0/architecture.md](../../../v0.5.0/architecture.md) Section 11 ADR roll-up table to include the five v0.6.0 ADRs and a pointer at the v0.6.0 architecture doc.

### 2.4 Sub-task 8.4 -- CHANGELOG update

The plan called for resolving the v0.5.0 `>=40%` token-savings claim by either confirming with a measured number from sub-task 2.3 or replacing it with the qualitative-deferred wording. Investigation: the `>=40%` claim never appeared in the v0.5.0 CHANGELOG entry itself; it lives in `docs/v0.5.0/plans/implementation-plan.md` and the Phase 12 history. Added an explicit `### v0.5.0 retrospective note` block at the end of the new `## [0.6.0]` entry that:
...
- [docs/adr/0006-unified-path-guard.md](../../../adr/0006-unified-path-guard.md)
- [docs/adr/0007-permission-tier-floor.md](../../../adr/0007-permission-tier-floor.md)
- [docs/adr/0008-panel-decomposition.md](../../../adr/0008-panel-decomposition.md)
- [docs/adr/0009-predictive-cache-decision.md](../../../adr/0009-predictive-cache-decision.md)
- [docs/adr/0010-threshold-elevation-decision.md](../../../adr/0010-threshold-elevation-decision.md)
- [docs/v0.6.0/analysis.md](../../analysis.md)
- [docs/v0.6.0/architecture.md](../../architecture.md)
- This file ([docs/v0.6.0/development/history/2026-05_phase-8-release-gate.md](2026-05_phase-8-release-gate.md))

**Modified** (significant):

- [src/config/GpuDetector.ts](../../../../src/config/GpuDetector.ts) -- added `: void` return type to `cb` callback (1 line).
- [tests/benchmarks/context-compaction.bench.ts](../../../../tests/benchmarks/context-compaction.bench.ts) -- replaced `createConversationManager` with `new ConversationManager("")`; added `StubEventEmitter` to vscode mock.
- [docs/adr/README.md](../../../adr/README.md) -- index extended with five new rows.
- [docs/v0.5.0/architecture.md](../../../v0.5.0/architecture.md) -- Section 11 ADR roll-up table extended with five new rows; cross-link added to v0.6.0 architecture doc.
- [CHANGELOG.md](../../../../CHANGELOG.md) -- new `## [0.6.0] -- 2026-05-04` block; original `## [Unreleased]` content (Phase 6 panel + Phase 5 PredictiveCache + gpuTier removals) folded into the v0.6.0 entry; `### Planned` block preserved under `## [Unreleased]`.
- [package.json](../../../../package.json) -- version bumped from `0.5.5` to `0.6.0` (sub-task 8.5).
...
- [x] `docs/v0.6.0/analysis.md` written.
- [x] `docs/v0.6.0/architecture.md` written.
