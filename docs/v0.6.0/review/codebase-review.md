...
**Inputs folded in**: [docs/v0.5.0/known-gaps.md](./known-gaps.md)
...
- **Location**: [docs/v0.5.0/known-gaps.md](./known-gaps.md) section 2.1; [tests/benchmarks/baselines/](../../../tests/benchmarks/baselines/)
...
- **Location**: [src/storage/ToolOutputCache.ts](../../../src/storage/ToolOutputCache.ts) `prune()` method; [docs/v0.5.0/architecture.md](../../v0.5.0/architecture.md) Section 4
...
| # | Phase | Location | Title |
|---|---|---|---|
| 17 | Security | docs/v0.5.0/plans/routa-harness-adoption.md | Obfuscate Slack webhook example |
